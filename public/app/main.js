(function(){
	...
	function initScreen(){
		...
		function loop(){
			...
			context.beginPath();
			context.arc(position.x * game.width, position.y * game.height, 30, 0, 2 * Math.PI, false);
	...
	function initController(){
		...
		socket.on('room', function(data){
			...
			if(data.success) {
				...
				erreur.innerHTML = "Room "+data.room+" introuvable";
			}
		});
		...
		function createController(){
			...
			function moveCircle(e){
				e.preventDefault();
				socket.emit('position', {x:e.touches[0].clientX / screen.width, y:e.touches[0].clientY / screen.height});
			}
			
			document.addEventListener('touchstart', moveCircle);
